...
private _preset = profileNamespace getVariable [QGVARMAIN(preset), []];
...
_preset pushBack [_exportName, +GVAR(inventory)];

profileNamespace setVariable [QGVARMAIN(preset), _preset];
