...
class KP_cratefiller {
        ...
        class KPCF_GroupTools: KPGUI_PRE_ControlsGroupNoScrollbars {
            ...
            class controls {
                ...
                class KPCF_DialogTitleTools: KPGUI_PRE_DialogTitleSR {
                    ...
                    x = QUOTE(KP_GETX(KP_X_VAL_SR,KP_WIDTH_VAL_SR,0,1) - safezoneX);
                    y = QUOTE(safeZoneY + safeZoneH * KP_Y_VAL_SR - safezoneY);
                };

                class KPCF_DialogAreaTools: KPGUI_PRE_DialogBackgroundSR {
                    x = QUOTE(KP_GETX(KP_X_VAL_SR,KP_WIDTH_VAL_SR,0,1) - safezoneX);
                    y = QUOTE(KP_GETY_AREA(KP_Y_VAL_SR) - safezoneY);
                };

                class KPCF_ComboGroups: KPGUI_PRE_Combo {
                    idc = KP_CRATEFILLER_IDC_COMBOGROUPS;
                    x = QUOTE(KP_GETCX(KP_X_VAL_SR,KP_WIDTH_VAL_SR,0,1) - safezoneX);
                    y = QUOTE(KP_GETCY(KP_Y_VAL_SR,KP_HEIGHT_VAL_SR,0,48) - safezoneY);
                    w = QUOTE(KP_GETW(KP_WIDTH_VAL_SR,1));
                    h = QUOTE(KP_GETH(KP_HEIGHT_VAL_SR,24));
                    tooltip = "$STR_KP_CRATEFILLER_GROUPS_TT";
                    onLBSelChanged = QUOTE([] call FUNC(getPlayers));
                };

                class KPCF_ComboPlayers: KPCF_ComboGroups {
                    idc = KP_CRATEFILLER_IDC_COMBOPLAYERS;
                    y = QUOTE(KP_GETCY(KP_Y_VAL_SR,KP_HEIGHT_VAL_SR,2,48) - safezoneY);
                    tooltip = "$STR_KP_CRATEFILLER_PLAYERS_TT";
                    onLBSelChanged = QUOTE([] call FUNC(getPlayerInventory));
                };
                ...
                class KPCF_MainWeapon: KPGUI_PRE_PictureRatio {
                    ...
                    x = QUOTE(KP_GETCX(KP_X_VAL_SR,KP_WIDTH_VAL_SR,0,1) - safezoneX);
                    y = QUOTE(KP_GETCY(KP_Y_VAL_SR,KP_HEIGHT_VAL_SR,6,48) - safezoneY);
                    w = QUOTE(KP_GETW(KP_WIDTH_VAL_SR,1));
                    h = QUOTE(KP_GETH(KP_HEIGHT_VAL_SR,4));
                };
                ...
                class KPCF_Handgun: KPCF_MainWeapon {
                    ...
                    y = QUOTE(KP_GETCY(KP_Y_VAL_SR,KP_HEIGHT_VAL_SR,21,48) - safezoneY);
                };
                ...
                class KPCF_SecondaryWeapon: KPCF_MainWeapon {
                    ...
                    y = QUOTE(KP_GETCY(KP_Y_VAL_SR,KP_HEIGHT_VAL_SR,36,48) - safezoneY);
                };
    ...
    class controls {
        ...
        class KPCF_Help: KPGUI_PRE_DialogCrossS {
            ...
            x = QUOTE(safeZoneX + safeZoneW * (KP_X_VAL_S + KP_WIDTH_VAL_S - 0.04));
        ...
        class KPCF_ButtonTools: KPGUI_PRE_DialogCrossS {
            ...
            x = QUOTE(safeZoneX + safeZoneW * (KP_X_VAL_S + KP_WIDTH_VAL_S - 0.08));
        ...
        class KPCF_TransportTitle: KPGUI_PRE_InlineTitle {
            ...
            x = QUOTE(KP_GETCX(KP_X_VAL_S,KP_WIDTH_VAL_S,0,1));
            y = QUOTE(KP_GETCY(KP_Y_VAL_S,KP_HEIGHT_VAL_S,0,48));
            w = QUOTE(KP_GETW(KP_WIDTH_VAL_S,1));
            h = QUOTE(KP_GETH(KP_HEIGHT_VAL_S,16));
        };

        class KPCF_ComboCrate: KPGUI_PRE_Combo {
            idc = KP_CRATEFILLER_IDC_COMBOCRATE;
            x = QUOTE(KP_GETCX(KP_X_VAL_S,KP_WIDTH_VAL_S,0,1));
            y = QUOTE(KP_GETCY(KP_Y_VAL_S,KP_HEIGHT_VAL_S,3,48));
            w = QUOTE(KP_GETW(KP_WIDTH_VAL_S,2));
            h = QUOTE(KP_GETH(KP_HEIGHT_VAL_S,24));
            tooltip = "$STR_KP_CRATEFILLER_CRATE_TT";
        };

        class KPCF_ComboStorage: KPCF_ComboCrate {
            idc = KP_CRATEFILLER_IDC_COMBOSTORAGE;
            x = QUOTE(KP_GETCX(KP_X_VAL_S,KP_WIDTH_VAL_S,1,2));
            w = QUOTE(KP_GETW(KP_WIDTH_VAL_S,(24/11)));
            tooltip = "$STR_KP_CRATEFILLER_INVENTORY_TT";
            onLBSelChanged = QUOTE([] call FUNC(showInventory));
        };

        class KPCF_RefreshCargo: KPGUI_PRE_CloseCross {
            text = "\z\KPCF\addons\cratefiller\ui\res\icon_refresh";
            x = QUOTE(KP_GETCX(KP_X_VAL_S,KP_WIDTH_VAL_S,23,24));
            y = QUOTE(KP_GETCY(KP_Y_VAL_S,KP_HEIGHT_VAL_S,3,48));
            w = QUOTE(KP_GETW(KP_WIDTH_VAL_S,24));
            h = QUOTE(KP_GETH(KP_HEIGHT_VAL_S,24));
            tooltip = "$STR_KP_CRATEFILLER_REFRESH_TT";
            action = QUOTE([] call FUNC(getNearStorages));
        };
        ...
        class KPCF_ButtonSpawnCrate: KPGUI_PRE_InlineButton {
            ...
            x = QUOTE(KP_GETCX(KP_X_VAL_S,KP_WIDTH_VAL_S,0,1));
            y = QUOTE(KP_GETCY(KP_Y_VAL_S,KP_HEIGHT_VAL_S,5,48));
            w = QUOTE(KP_GETW(KP_WIDTH_VAL_S,2));
            h = QUOTE(KP_GETH(KP_HEIGHT_VAL_S,24));
            onButtonClick = QUOTE([] call FUNC(spawnCrate));
        };
        ...
        class KPCF_ButtonDeleteCrate: KPCF_ButtonSpawnCrate {
            ...
            x = QUOTE(KP_GETCX(KP_X_VAL_S,KP_WIDTH_VAL_S,1,2));
            y = QUOTE(KP_GETCY(KP_Y_VAL_S,KP_HEIGHT_VAL_S,5,48));
            onButtonClick = QUOTE([] call FUNC(deleteCrate));
        };
        ...
        class KPCF_EquipmentTitle: KPCF_TransportTitle {
            ...
            y = QUOTE(KP_GETCY(KP_Y_VAL_S,KP_HEIGHT_VAL_S,7,48));
            w = QUOTE(KP_GETW(KP_WIDTH_VAL_S,2));
        };
        ...
        class KPCF_ComboEquipment: KPGUI_PRE_Combo {
            ...
            x = QUOTE(KP_GETCX(KP_X_VAL_S,KP_WIDTH_VAL_S,0,1));
            y = QUOTE(KP_GETCY(KP_Y_VAL_S,KP_HEIGHT_VAL_S,10,48));
            w = QUOTE(KP_GETW(KP_WIDTH_VAL_S,2));
            h = QUOTE(KP_GETH(KP_HEIGHT_VAL_S,24));
            tooltip = "$STR_KP_CRATEFILLER_CATEGORY_TT";
            onLBSelChanged = QUOTE([] call FUNC(createEquipmentList));
        };

        class KPCF_ComboWeapons: KPCF_ComboEquipment {
            idc = KP_CRATEFILLER_IDC_COMBOWEAPONS;
            y = QUOTE(KP_GETCY(KP_Y_VAL_S,KP_HEIGHT_VAL_S,12,48));
            w = QUOTE(KP_GETW(KP_WIDTH_VAL_S,3));
            tooltip = "$STR_KP_CRATEFILLER_WEAPONSELECTION_TT";
            onLBSelChanged = QUOTE([] call FUNC(createSubList));
        };

        class KPCF_SearchBar: KPGUI_PRE_EditBox {
            idc = KP_CRATEFILLER_IDC_SEARCHBAR;
            x = QUOTE(KP_GETCX(KP_X_VAL_S,KP_WIDTH_VAL_S,1,3));
            y = QUOTE(KP_GETCY(KP_Y_VAL_S,KP_HEIGHT_VAL_S,12,48));
            w = QUOTE(KP_GETW(KP_WIDTH_VAL_S,6));
            h = QUOTE(KP_GETH(KP_HEIGHT_VAL_S,24));
            tooltip = "$STR_KP_CRATEFILLER_SEARCH_TT";
            onKeyUp = QUOTE([] call FUNC(search));
        };
        ...
        class KPCF_EquipmentList: KPGUI_PRE_ListNBox {
            ...
            x = QUOTE(KP_GETCX(KP_X_VAL_S,KP_WIDTH_VAL_S,0,1));
            y = QUOTE(KP_GETCY(KP_Y_VAL_S,KP_HEIGHT_VAL_S,14,48));
            w = QUOTE(KP_GETW(KP_WIDTH_VAL_S,(2)));
            h = QUOTE(KP_GETH(KP_HEIGHT_VAL_S,(48/32)));
        ...
        class KPCF_ExportName: KPGUI_PRE_EditBox {
            ...
            x = QUOTE(KP_GETCX(KP_X_VAL_S,KP_WIDTH_VAL_S,2,4));
            y = QUOTE(KP_GETCY(KP_Y_VAL_S,KP_HEIGHT_VAL_S,10,48));
            w = QUOTE(KP_GETW(KP_WIDTH_VAL_S,4));
            h = QUOTE(KP_GETH(KP_HEIGHT_VAL_S,24));
        ...
        class KPCF_ImportName: KPGUI_PRE_Combo {
            ...
            x = QUOTE(KP_GETCX(KP_X_VAL_S,KP_WIDTH_VAL_S,3,4));
            y = QUOTE(KP_GETCY(KP_Y_VAL_S,KP_HEIGHT_VAL_S,10,48));
            w = QUOTE(KP_GETW(KP_WIDTH_VAL_S,4));
            h = QUOTE(KP_GETH(KP_HEIGHT_VAL_S,24));
        ...
        class KPCF_ButtonExport: KPGUI_PRE_InlineButton {
            ...
            w = QUOTE(KP_GETW(KP_WIDTH_VAL_S,4));
            h = QUOTE(KP_GETH(KP_HEIGHT_VAL_S,24));
            onButtonClick = QUOTE([] call FUNC(export));
        };

        class KPCF_ButtonImport: KPCF_ButtonExport {
            text = "$STR_KP_CRATEFILLER_IMPORT";
            x = QUOTE(KP_GETCX(KP_X_VAL_S,KP_WIDTH_VAL_S,3,4));
            w = QUOTE(KP_GETW(KP_WIDTH_VAL_S,(24/5)));
            onButtonClick = QUOTE([] call FUNC(import));
        };
        ...
        class KPCF_InventoryList: KPGUI_PRE_ListNBox {
            ...
            x = QUOTE(KP_GETCX(KP_X_VAL_S,KP_WIDTH_VAL_S,8,16));
            y = QUOTE(KP_GETCY(KP_Y_VAL_S,KP_HEIGHT_VAL_S,14,48));
            w = QUOTE(KP_GETW(KP_WIDTH_VAL_S,(16/7)));
            h = QUOTE(KP_GETH(KP_HEIGHT_VAL_S,(52/32)));
        ...
        class KPCF_ClearInventory: KPGUI_PRE_InlineButton {
            ...
            x = QUOTE(KP_GETCX(KP_X_VAL_S,KP_WIDTH_VAL_S,8,16));
            y = QUOTE(KP_GETCY(KP_Y_VAL_S,KP_HEIGHT_VAL_S,44,48));
            w = QUOTE(KP_GETW(KP_WIDTH_VAL_S,2));
            h = QUOTE(KP_GETH(KP_HEIGHT_VAL_S,24));
            onbuttonClick = QUOTE([] call FUNC(setInventory));
        };

        class KPCF_ProgressBar : KPGUI_PRE_ProgressBar {
            idc = KP_CRATEFILLER_IDC_PROGRESSBAR;
            x = QUOTE(KP_GETCX(KP_X_VAL_S,KP_WIDTH_VAL_S,0,1));
            y = QUOTE(KP_GETCY(KP_Y_VAL_S,KP_HEIGHT_VAL_S,46,48));
            w = QUOTE(KP_GETW(KP_WIDTH_VAL_S,1));
            h = QUOTE(KP_GETH(KP_HEIGHT_VAL_S,24));
